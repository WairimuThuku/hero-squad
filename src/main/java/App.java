...
import static models.Hero.setUpNewHero;
import static models.Hero.setUpNewHero1;
...
public class App {
    ...
    public static void main(String[] args){
        ...
        Spark.get("/hero-form",(req, res) ->{
            Map<String, Object> model = new HashMap<>();
            return new ModelAndView(model, "hero-form.hbs");
        }, new HandlebarsTemplateEngine());

        Spark.get("/hero",(req, res) ->{
            Map<String, Object> model = new HashMap<>();
        ...
        Spark.get("/new/:id",(req, res) ->{
            Map<String, Object> model = new HashMap<>();
            String idOfHero = req.params("id");
            Hero foundHero = Hero.findById(idOfHero);
            model.put("hero",foundHero);
            return new ModelAndView(model, "more.hbs");
        }, new HandlebarsTemplateEngine());

        Spark.get("/squad-form",(req, res) ->{
            Map<String, Object> model = new HashMap<>();
            return new ModelAndView(model, "squad-form.hbs");
        }, new HandlebarsTemplateEngine());

        Spark.get("/squad",(req, res) ->{
            Map<String, Object> model = new HashMap<>();
        ...
        Spark.get("/new/member/:squadId",(req, res)->{
            Map<String, Object> model = new HashMap<>();
        ...
        Spark.get("/squad/new/:id",(req, res)->{
            Map<String, Object> model = new HashMap<>();
